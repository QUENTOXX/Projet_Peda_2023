<?php
  ...
  if (isset($_POST['valider'])) {
    ...
    if (empty($permis) || !ctype_alpha($permis)) {
      $erreur .= "Le Permis doit être renseignée <br>";
    }

    if (empty($vehicule) || !ctype_alpha($vehicule)) {
      $erreur .= "Le vehicule doit être renseignée <br>";
    }
    ...
    if(checkEmail($email)){
      ...
      $erreur .= "Ce livreur existe déjà veuillez réessayer <br>";
    }  
  } 
} 
?>
